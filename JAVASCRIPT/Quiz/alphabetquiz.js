...
const alphabetData = [
    { letter: 'A', video: '/PICTURES/fsl_alphabet/QUIZ/A.mp4' },
    { letter: 'B', video: '/PICTURES/fsl_alphabet/QUIZ/B.mp4' },
    { letter: 'C', video: '/PICTURES/fsl_alphabet/QUIZ/C.mp4' },
    { letter: 'D', video: '/PICTURES/fsl_alphabet/QUIZ/D.mp4' },
    { letter: 'E', video: '/PICTURES/fsl_alphabet/QUIZ/E.mp4' },
    { letter: 'F', video: '/PICTURES/fsl_alphabet/QUIZ/F.mp4' },
    { letter: 'G', video: '/PICTURES/fsl_alphabet/QUIZ/G.mp4' },
    { letter: 'H', video: '/PICTURES/fsl_alphabet/QUIZ/H.mp4' },
    { letter: 'I', video: '/PICTURES/fsl_alphabet/QUIZ/I.mp4' },
    { letter: 'J', video: '/PICTURES/fsl_alphabet/QUIZ/J.mp4' },
    { letter: 'K', video: '/PICTURES/fsl_alphabet/QUIZ/K.mp4' },
    { letter: 'L', video: '/PICTURES/fsl_alphabet/QUIZ/L.mp4' },
    { letter: 'M', video: '/PICTURES/fsl_alphabet/QUIZ/M.mp4' },
    { letter: 'N', video: '/PICTURES/fsl_alphabet/QUIZ/N.mp4' },
    { letter: 'O', video: '/PICTURES/fsl_alphabet/QUIZ/O.mp4' },
    { letter: 'P', video: '/PICTURES/fsl_alphabet/QUIZ/P.mp4' },
    { letter: 'Q', video: '/PICTURES/fsl_alphabet/QUIZ/Q.mp4' },
    { letter: 'R', video: '/PICTURES/fsl_alphabet/QUIZ/R.mp4' },
    { letter: 'S', video: '/PICTURES/fsl_alphabet/QUIZ/S.mp4' },
    { letter: 'T', video: '/PICTURES/fsl_alphabet/QUIZ/T.mp4' },
    { letter: 'U', video: '/PICTURES/fsl_alphabet/QUIZ/U.mp4' },
    { letter: 'V', video: '/PICTURES/fsl_alphabet/QUIZ/V.mp4' },
    { letter: 'W', video: '/PICTURES/fsl_alphabet/QUIZ/W.mp4' },
    { letter: 'X', video: '/PICTURES/fsl_alphabet/QUIZ/X.mp4' },
    { letter: 'Y', video: '/PICTURES/fsl_alphabet/QUIZ/Y.mp4' },
    { letter: 'Z', video: '/PICTURES/fsl_alphabet/QUIZ/Z.mp4' }
];
...
function handleQuizAbandonedInOtherTab() {
    ...
    showAutoCloseMessage('Quiz was abandoned in another tab. Closing this tab...', () => {
        window.location.href = '/HTML/Lesson/alphabet.html';
    });
}
...
function generateQuestions() {
    ...
    const maxQuestions = Math.min(10, alphabetData.length);
...
async function handleVisibilityChange() {
    ...
    const isOnQuizPage = currentPath.includes('alphabetquiz.html');
    ...
    if (user) {
        ...
        if (navigator.onLine) {
            ...
            if (activeSession && activeSession.active && !isOnQuizPage) {
                ...
                window.location.href = basePath + '/HTML/Quiz/alphabetquiz.html';
            }
        }
    } else {
        currentUser = null;
