...
const whquestionsData = [
    { question: "ANO", video: '/PICTURES/fsl_basic_wh_questions/ANO.mp4' },
    { question: "SINO", video: '/PICTURES/fsl_basic_wh_questions/SINO.mp4' },
    { question: "SAAN", video: '/PICTURES/fsl_basic_wh_questions/SAAN.mp4' },
    { question: "KAILAN", video: '/PICTURES/fsl_basic_wh_questions/KAILAN.mp4' },
    { question: "BAKIT", video: '/PICTURES/fsl_basic_wh_questions/BAKIT.mp4' },
    { question: "PAANO", video: '/PICTURES/fsl_basic_wh_questions/PAANO.mp4' }
];
...
async function saveActiveQuizSession() {
    ...
    try {
        const sessionRef = doc(db, 'users', currentUser.uid, 'activeQuiz', 'wh-questions-quiz');
