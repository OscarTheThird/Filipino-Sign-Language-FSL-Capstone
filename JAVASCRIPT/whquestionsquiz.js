...
// Generate quiz questions (all 6 questions)
...
function generateOptions(correctQuestion) {
    ...
    const availableQuestions = whQuestionsData.map(item => item.question).filter(question => question !== correctQuestion);
...
async function saveQuizProgress() {
    ...
    try {
        const quizRef = doc(db, 'users', currentUser.uid, 'quizzes', 'whquestions');
